...
class EvaluatorIBLG_LONG_ANGLE_ONLY_UP_02(EvaluatorBase,AperturaBase,CierreBase):

    def __init__(self):
        #se añade cierre mas permisivo
        self.name = "EvaluatorIBLG_LONG_ANGLE_ONLY_UP_02"
    ...
    def evaluarFlujoBUY_LONG(self, results, activeParam):
        ...
        self.control_BUY_START_CLOSE_02(results, activeParam, self.closeAcumValue, self.closeDifference)
