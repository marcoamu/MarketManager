...
class EvaluatorDistIndicatorTendence03(EvaluatorBase,AperturaBase,CierreBase):

    def __init__(self):
        self.name = "EvaluatorDistIndicatorTendence03"
    ...
    def evaluarFlujoBUY(self,results, activeParam):
        ...
        #EVALUACION CRITERIOS DE CIERRE
        ...
        if results[Constants.FLUJO] == Constants.FLUJO_BAJA:
            # EVITAMOS CERRAR IN difference_optimized, unit_diff = MEDIATAMENTE
