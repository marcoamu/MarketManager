...
class EvaluatorIBLG_LONG_03(EvaluatorBase,AperturaBase,CierreBase):
...
#                         print(
                        ...
                        if results[Constants.ANGLE] < 0 or results[
                            ...
                            if abs(results[Constants.ANGLE]) > self.angleDOWN:
                                results[Constants.NEW_ACTION] = Constants.ACTION_SELL
#                                 print(
                                    f" INICIO MERCADO DOWN_ANGLE_01 {results[Constants.DATE].values[0]} Acum: {results[Constants.ACUMULADO_ABS]} medddiff {results[Constants.MEDSTDDIFF]} angle: {results[Constants.ANGLE]} direction {results[Constants.DIRECTION]} INDICATOR_MED_MOMENT {results[Constants.INDICATOR_MED_MOMENT]}")
                            else:
                                if results[Constants.ANGLEm1] > 0:
                                    # esta bajando o haciendo el cambio
                                    results[Constants.NEW_ACTION] = Constants.ACTION_SELL
#                                     print(
                                        f" INICIO MERCADO DOWN_ANGLE_02 {results[Constants.DATE].values[0]} Acum: {results[Constants.ACUMULADO_ABS]} medddiff {results[Constants.MEDSTDDIFF]} angle: {results[Constants.ANGLE]} direction {results[Constants.DIRECTION]} INDICATOR_MED_MOMENT {results[Constants.INDICATOR_MED_MOMENT]}")
                else:
                    nada = ""
                    ...
                    #         results[Constants.NEW_ACTION] = Constants.ACTION_BUY
                    #         print(
                    #             f" INICIO MERCADO DOWN_INVERSE_BUY_01 {results[Constants.DATE].values[0]} Acum: {results[Constants.ACUMULADO_ABS]} medddiff {results[Constants.MEDSTDDIFF]} angle: {results[Constants.ANGLE]} direction {results[Constants.DIRECTION]} INDICATOR_MED_MOMENT {results[Constants.INDICATOR_MED_MOMENT]}")
...
#                         print(
                        ...
                        if results[Constants.ANGLE] > 0 or results[
                            ...
                            if abs(results[Constants.ANGLE]) > self.angleUP:
                                results[Constants.NEW_ACTION] = Constants.ACTION_BUY
#                                 print(
                                            f" INICIO MERCADO UP_UP_BUY_ANGLE_01 {results[Constants.DATE].values[0]} Acum: {results[Constants.ACUMULADO_ABS]} medddiff {results[Constants.MEDSTDDIFF]} angle: {results[Constants.ANGLE]} direction {results[Constants.DIRECTION]} INDICATOR_MED_MOMENT {results[Constants.INDICATOR_MED_MOMENT]}")
                            else:
                                if results[Constants.ANGLEm1] <0:
                                    # esta subiendo o haciendo el cambio
                                    results[Constants.NEW_ACTION] = Constants.ACTION_BUY
#                                     print(
                                        f" INICIO MERCADO UP_UP_BUY_ANGLE_02 {results[Constants.DATE].values[0]} Acum: {results[Constants.ACUMULADO_ABS]} medddiff {results[Constants.MEDSTDDIFF]} angle: {results[Constants.ANGLE]} direction {results[Constants.DIRECTION]} INDICATOR_MED_MOMENT {results[Constants.INDICATOR_MED_MOMENT]}")
                else:
                    #BAJA
                    nada=""
                    if abs(results[Constants.MEDSTDDIFF]) > self.medstdminDiff:
                        ...
                        results[Constants.NEW_ACTION] = Constants.ACTION_SELL
#                         print(
                            f" INICIO MERCADO UP_SELL_INVERSE_01 {results[Constants.DATE].values[0]} Acum: {results[Constants.ACUMULADO_ABS]} medddiff {results[Constants.MEDSTDDIFF]} angle: {results[Constants.ANGLE]} direction {results[Constants.DIRECTION]} INDICATOR_MED_MOMENT {results[Constants.INDICATOR_MED_MOMENT]}")
