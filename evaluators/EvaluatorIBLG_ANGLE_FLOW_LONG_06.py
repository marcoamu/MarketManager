...
class EvaluatorIBLG_ANGLE_FLOW_LONG_06(EvaluatorBase,AperturaBase,CierreBase):

    #tiene EMA MIN DST

    def __init__(self):
        #se añade blg_mid_distance closenxt_middle
        self.name = "EvaluatorIBLG_ANGLE_FLOW_LONG_06"
        # self.name = "EvaluatorIBLG_ANGLE_FLOW_LONG_03"
...
#                 print(f"FUERA DE HORARIO")
    ...
    def evaluarFlujoSELL_LONG(self, results, activeParam):
        ...
        self.control_SELL_BLG_LONG_03(results, activeParam, self.closeAcumValue, self.closeDifference, self.accumulate)
