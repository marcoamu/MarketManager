...
class EvaluatorIBLG_WEEK_FLOW_02(EvaluatorBase,AperturaBase,CierreBase):
    ...
    def evaluarFlujoSELL_LONG(self, results, activeParam):
        ...
        print(
            f"DIFFERENCE_OPTIMIZED  evaluarFlujoSELL {difference_optimized} original {activeParam.difference} closeAcumValue {self.closeAcumValue} close difference {self.closeDifference} unit_diffb {unit_diff}")
