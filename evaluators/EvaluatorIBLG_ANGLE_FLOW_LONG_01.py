...
class EvaluatorIBLG_ANGLE_FLOW_LONG_01(EvaluatorBase,AperturaBase,CierreBase):
...
#                 print(f"FUERA DE HORARIO")
    ...
    def evaluarAperturaDOWN(self, results, activeParam, flujo_count):
        ...
        res, num = self.evaluateDownOpen_01(results,activeParam)
        if res:
    ...
    def evaluarFlujoBUY_LONG(self, results, activeParam):
        ...
        # self.control_BUY_BLG_LONG_01(results, activeParam, self.closeAcumValue, self.closeDifference,self.accumulate)
    ...
    def evaluarFlujoSELL_LONG(self, results, activeParam):
        ...
        # self.control_SELL_BLG_LONG_01(results, activeParam, self.closeAcumValue, self.closeDifference, self.accumulate)
