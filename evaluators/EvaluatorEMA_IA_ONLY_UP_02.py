...
class EvaluatorEMA_IA_ONLY_UP_02(EvaluatorBase,AperturaBase,CierreBase):
    ...
    def __init__(self):
        self.name = "EvaluatorEMA_IA_ONLY_UP_02"
    ...
    def evaluarAperturaEMA(self, results, activeParam):
        ...
        # ================================
        ema_angle = self.safe_float(results.get(Constants.ANGLE_IMA1))
        ...
        ema_distance = abs(results[Constants.EMA_DST])
