...
class EvaluatorDIRECTION_MEDSTD_04(EvaluatorBase, AperturaBase, CierreBase):

    def __init__(self):
        self.name = 'EvaluatorDIRECTION_MEDSTD_04'
    ...
    def evaluarApertura(self, results, activeParam):
        ...
        if results[Constants.DIRECTION] == Constants.DIR_PRE_UP:
            ...
            nada = ''
            self.evaluarAperturaCHANGEOK(results, activeParam, flujo_count)
        else:
            pass
    ...
    def evaluarAperturaCHANGEOK(self, results, activeParam, flujo_count):
        difference_optimized = activeParam.difference
        unit_diff = 0
        multiplicador = 2
        difference_optimized, unit_diff = self.evaluarAperturaCHANGEDifference(results, activeParam, flujo_count)
