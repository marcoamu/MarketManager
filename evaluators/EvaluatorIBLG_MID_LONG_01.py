...
class EvaluatorIBLG_MID_LONG_01(EvaluatorBase,AperturaBase,CierreBase):
    ...
    def evaluarFlujoBUY_LONG(self, results, activeParam):
        ...
        self.control_BUY_BLG_MID_01(results, activeParam, self.closeAcumValue, self.closeDifference,self.accumulate)
