...
class Evaluator01(EvaluatorBase,AperturaBase,CierreBase):

    def __init__(self):
        self.name = "Evaluator01"
            ...
            if results[Constants.IMA_NEW] == Constants.IMA_NEW_BUY:
                ...
                if results[Constants.FLUJO] == Constants.FLUJO_BAJA:
                    if results[Constants.MARKET_TENDENCE] == Constants.MARKET_TENDENCE_DOWN:
                        ...
                        #     if results[Constants.ACUMULADO_ABS] >= activeParam.difference:
                        #         results[Constants.CURRENT_ACTION] = Constants.ACTION_SELL
                        #         alert = True
                        #         isSell = True
