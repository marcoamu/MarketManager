...
class EvaluatorDistIndicatorTenOnlyUp01(EvaluatorBase,AperturaBase,CierreBase):

    def __init__(self):
        self.name = "EvaluatorDistIndicatorTenOnlyUp01"
