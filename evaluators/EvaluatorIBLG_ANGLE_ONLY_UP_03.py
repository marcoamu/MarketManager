...
class EvaluatorIBLG_ANGLE_ONLY_UP_03(EvaluatorBase, AperturaBase, CierreBase):
    ...
    def evaluarFlujoBUY_LONG(self, results, activeParam):
        ...
        self.control_BUY_LONG_ONLYUP_01(results, activeParam, self.closeAcumValue, self.closeDifference, self.accumulate)
    ...
    def evaluarFlujoSELL_LONG(self, results, activeParam):
        ...
        self.control_SELL_LONG_ONLYUP_01(results, activeParam, self.closeAcumValue, self.closeDifference, self.accumulate)