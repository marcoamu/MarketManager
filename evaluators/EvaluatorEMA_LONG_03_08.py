...
class EvaluatorEMA_LONG_03_08(EvaluatorBase,AperturaBase,CierreBase):
    ...
    def __init__(self):
        self.name = "EvaluatorEMA_LONG_03_08"
    ...
    def evaluarFlujoSELL(self, results, activeParam):
        ...
        self.printDifference("evaluarFlujoSELL", difference_optimized, self.closeAcumValue, self.closeDifference,
                             self.accumulate)
        self.control_SELL_EMA_WEEK_NEW_FLOW_01(results, activeParam, self.closeAcumValue, self.closeDifference)
