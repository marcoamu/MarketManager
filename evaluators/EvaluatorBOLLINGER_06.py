...
class EvaluatorBOLLINGER_06(EvaluatorBase,AperturaBase,CierreBase):
...
#                         print(
                        ...
                        results[Constants.CLOSE_NXT_DOWN] = 0
#                         print(
                            f" INICIO MERCADO UP_BLG_BUY2 acum: {results[Constants.ACUMULADO_ABS]} medddiff {results[Constants.MEDSTDDIFF]} percentSTD: {results[Constants.IND_REL_PERCENT_STD]}")
                        return
