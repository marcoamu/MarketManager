...
class EvaluatorDirectionMEDSTD03_01(EvaluatorBase,AperturaBase,CierreBase):

    def __init__(self):
        self.name = "EvaluatorDirectionMEDSTD03_01"
    ...
    def evaluarAperturaCHANGE(self, results, activeParam, flujo_count):
        ...
        # if results[Constants.INDICATOR_MED_MOMENT] == Constants.MARKET_TENDENCE_DOWN:
