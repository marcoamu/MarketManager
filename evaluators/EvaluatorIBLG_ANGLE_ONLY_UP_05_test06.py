...
class EvaluatorIBLG_ANGLE_ONLY_UP_05_test06(EvaluatorBase,AperturaBase,CierreBase):

    def __init__(self):
        #se añade cierre mas permisivo
        #se añade ontrol de apertura nxt up usando angleFlow
        self.name = "EvaluatorIBLG_ANGLE_ONLY_UP_05_test06"
        # self.name = "EvaluatorIBLG_ANGLE_ONLY_UP_05_test03"
...
#             print(f"ESTAMOS A LA ESPERA DE INDICADORES BUENOS")
    ...
    def evaluarAperturaUP(self, results, activeParam, flujo_count):
        ...
        res, option = self.evaluateUpOpen_06(results, activeParam)
        if res:
            if results[Constants.HOURLY_ANGLE_MED] >0:
                results[Constants.NEW_ACTION] = Constants.ACTION_BUY
