...
__all__ = ['EvaluatorBase', 'EvaluationResult', 'EvaluatorFactory', 'register_evaluator', 'BollingerStrategy', 'EMAStrategy', 'DirectionStrategy', 'OnlyUpStrategy', 'MEDSTDStrategy', 'IBLGStrategy']