...
class EvaluatorEMA_LONG_03_07(EvaluatorBase,AperturaBase,CierreBase):
    ...
    def __init__(self):
        self.name = "EvaluatorEMA_LONG_03_07"
    ...
    def evaluarAperturaDOWN(self, results, activeParam, flujo_count):
        ...
        res, action, num = self.evaluateDownOpen_EMA_WEEK_NEW_FLOW_02(results, activeParam)
        if res:
            if "BUY" in action:
                nada = ""
    ...
    def evaluarFlujoSELL(self, results, activeParam):
        ...
        self.printDifference("evaluarFlujoSELL", difference_optimized, self.closeAcumValue, self.closeDifference,
                             self.accumulate)
        self.control_SELL_EMA_WEEK_NEW_FLOW_02(results, activeParam, self.closeAcumValue, self.closeDifference)
