...
#DIS
class ParamDIS06(Parameters):

    def __init__(self, isDBData):
        super().__init__()
        self.paramName = "ParamDIS06"
        self.difference = 0.17
        self.accumulate = 0.30
        self.unit = 0.03
        self.draw = False
        self.round = 2
        ...
        self.relativeDistance = 3.0#para indicar el maximo de distancia en relative
