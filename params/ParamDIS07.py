...
#DIS
class ParamDIS07(Parameters):

    def __init__(self, isDBData):
        super().__init__()
        self.paramName = "ParamDIS07"
        self.difference = 0.09
        self.accumulate = 0.15
        self.unit = 0.03
        self.draw = False
        self.round = 2
        ...
        self.relativeDistance = 1.0#para indicar el maximo de distancia en relative
        self.relativeDistanceMultiplicator = 0.25#para sacar el porcentaje del valor minimo para relative
