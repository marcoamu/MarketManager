...
#APPL
class ParamSONY03(Parameters):

    def __init__(self, isDBData):
        super().__init__()
        self.paramName = "ParamSONY03"
        self.difference = 0.08
        self.accumulate = 0.20
        self.unit = 0.02
        self.draw = False
        self.round = 2
        ...
        self.emaMinDst = 0.30
        self.weekInterval = 20
        # self.startProbDef = 'getProb_WEEK_DIRECTION_02'
        # self.startProbDef = 'evaluate_WEEK_ANGLE_FLOW_START_03'
        # self.endProbDef = 'getProMEDSTD_END_BLG_05'
        # self.endProbDef = 'evaluate_WEEK_ANGLE_FLOW_END_03'
