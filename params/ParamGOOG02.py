...
#AMZN
class ParamGOOG02(Parameters):

    def __init__(self, isDBData):
        super().__init__()
        self.paramName = "ParamGOOG02"
        self.difference = 0.16
        self.accumulate = 0.3
        self.unit = 0.05
        self.draw = False
        self.round = 2
        ...
        # self.endProbDef = 'getProMEDSTD_END_BLG_06'
        ...
        self.ima1EmaMinValue = 0.20  # si esta mas alto que esto es que es una buena distancia
        self.closeAngleDiff = 1.2  # grados para cerrar una apertura
        self.closeAcumvalue = 0.26
