...
#KO
class ParamKO04(Parameters):

    def __init__(self, isDBData):
        super().__init__()
        self.paramName = "ParamKO04"
        self.difference = 0.020
        self.accumulate = 0.1
        self.unit = 0.01
        self.draw = False
        self.round = 2
        ...
        self.minSTDNormal = 0.010
        self.maxSTDNormal = 0.010
        self.minMEDNormal = 0.026
        self.maxMEDNormal = 0.030
        self.weekDistanceMedDistance = 1.5
        self.relativeDistance = 0.6#para indicar el maximo de distancia en relative
        ...
        # self.closeAngleDiff = 0.65  # grados para cerrar una apertura
